...
TimerView.prototype.getColour = function (colourAnimators) {
	var currentColour = "#" + ("0" + parseInt(colourAnimators.rAnimator.getValue(), 10).toString(16)).slice(-2) + ("0" + parseInt(colourAnimators.gAnimator.getValue(), 10).toString(16)).slice(-2) + ("0" + parseInt(colourAnimators.bAnimator.getValue(), 10).toString(16)).slice(-2);
